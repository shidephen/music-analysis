...
public class AudioProcessor {
	...
	public AudioProcessor() {
		...
		fftTime =0.046439909297052;	// DEFAULT, overridden with -f
	...
	public void setInputFile(String fileName) {
		...
		try {
			...
			/////////////////////////нт╡ш
			int a=Math.round((float) (sampleRate*hopTime));
			int b=Math.round((float)(sampleRate*fftTime));
			
			hopTime=a/sampleRate;
			fftTime=b/sampleRate;
